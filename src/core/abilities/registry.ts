...
import criticalJudgment from "../../content/abilities/player-skills/critical-judgment.json" with { type: "json" };
import situationAssessment from "../../content/abilities/player-skills/situation-assessment.json" with { type: "json" };
import liveAmmunitionBet from "../../content/abilities/player-skills/live-ammunition-bet.json" with { type: "json" };
import prepaidPremium from "../../content/abilities/player-skills/prepaid-premium.json" with { type: "json" };
import heartHunter from "../../content/abilities/player-skills/heart-hunter.json" with { type: "json" };
...
import compoundInterest from "../../content/abilities/player-skills/compound-interest.json" with { type: "json" };
import counterclockwiseClock from "../../content/abilities/player-skills/counterclockwise-clock.json" with { type: "json" };
import sissasTable from "../../content/abilities/player-skills/sissas-table.json" with { type: "json" };
import aSingleCoin from "../../content/abilities/player-skills/a-single-coin.json" with { type: "json" };
import mimicEggplant from "../../content/abilities/player-skills/mimic-eggplant.json" with { type: "json" };
import carnival from "../../content/abilities/player-skills/carnival.json" with { type: "json" };
import beforeTheShuffle from "../../content/abilities/player-skills/before-the-shuffle.json" with { type: "json" };
import quetzalMemory from "../../content/abilities/player-skills/quetzal-memory.json" with { type: "json" };
import pegasusVision from "../../content/abilities/player-skills/pegasus-vision.json" with { type: "json" };
import sleightOfHand from "../../content/abilities/player-skills/sleight-of-hand.json" with { type: "json" };
...
import aiTinScorch from "../../content/abilities/ai-skills/ai-tin-scorch.json" with { type: "json" };
...
import typhonEternalHunt from "../../content/abilities/ai-skills/typhon-eternal-hunt.json" with { type: "json" };
...
import playerPointAdvantageStatus from "../../content/abilities/statuses/player-point-advantage.json" with { type: "json" };
import carnivalBustBonusStatus from "../../content/abilities/statuses/carnival-bust-bonus.json" with { type: "json" };
...
import pegasusVisionAdvantageStatus from "../../content/abilities/statuses/pegasus-vision-advantage.json" with { type: "json" };
...
export const ABILITY_CATALOG_VERSION = "abilities-v28" as const;
