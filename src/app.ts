...
function renderLobby(layer: LobbyLayer = "menu"): void {
  ...
  root.innerHTML = layer === "menu"
    ? `<main class="lobby-shell lobby-menu-shell"><header class="lobby-invitation"><span>策展人的邀请</span><span>NO. 001</span></header><section class="lobby-title-block" aria-labelledby="lobby-title"><p class="menu-overline">今夜，古堡只接待有求之人</p><h1 id="lobby-title">绝命之夜</h1><div class="menu-subtitle"><span></span><strong>终焉赌局</strong></div><div class="menu-oath"><p>奉上自己的一切，包括自己的身体。</p><p>一点点的技巧和运气，以及全部的决心。</p><strong>祂终将有求必应。</strong></div></section><nav class="lobby-menu" aria-label="古堡主菜单"><button type="button" class="lobby-menu-button lobby-primary-action" data-enter-duel><span class="button-number">01</span><span class="button-copy"><strong>对决</strong><small>选择一名与会者</small></span><span class="button-arrow" aria-hidden="true">›</span></button><div class="lobby-secondary-menu"><button type="button" class="lobby-menu-button lobby-secondary-action" data-open="rules"><span class="button-number">02</span><strong>玩法说明</strong></button><button type="button" class="lobby-menu-button lobby-secondary-action" data-open="skills"><span class="button-number">03</span><strong>技能管理</strong></button><button type="button" class="lobby-menu-button lobby-secondary-action" data-open-trophies><span class="button-number">04</span><strong>战利品陈列室</strong><small>${save.history.length} 局</small></button></div></nav>${lobbyDialogsMarkup()}</main>`
